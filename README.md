...
|  |  |
|---|---|
| 🗂️ **Multi‑environment tabs** | Manage your home lab and every client cluster side by side. Switch between them **instantly** — each one stays loaded. |
...
- The app only ever **appends** keys to `authorized_keys` — it never removes or
  rewrites anything.
